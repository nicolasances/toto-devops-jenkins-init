...
public class JenkinsMongoJobDescriptor implements JenkinsJobDescriptor {
	...
	private File createTemplateCopy() {
		...
		InputStream templateIS = this.getClass().getClassLoader().getResourceAsStream("jenkins-mongo-job-pipeline.xml");
