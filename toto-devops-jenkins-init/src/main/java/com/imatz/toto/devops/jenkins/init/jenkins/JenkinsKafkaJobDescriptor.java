...
public class JenkinsKafkaJobDescriptor implements JenkinsJobDescriptor {
	...
	private File createTemplateCopy() {
		...
		InputStream templateIS = this.getClass().getClassLoader().getResourceAsStream("jenkins-kafka-job-pipeline.xml");
